...
| --- | --- | --- | --- |
| [ACCOUNT_MANAGER broad-membership money exposure](./account-manager-granular-rbac-redaction.md) | `erify_api` studio authorization | Phase 6 granular RBAC work, or before `ACCOUNT_MANAGER` is enabled for live studio users | [PHASE_6.md](../roadmap/PHASE_6.md), [Client mechanics PRD](../prd/client-mechanics.md) |

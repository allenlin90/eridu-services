...
| [erify_studios bundle/performance — deferred items](./erify-studios-bundle-perf.md) | `erify_studios` first-load bundle | A library exposes a lazy-friendly seam for date-picker/drawer, or a caching-only vendor-split pass is wanted for app-wide infra | Perf pass complete (−50% first-load, PRs #202/#203/#206) |

...
| [BullMQ Async Processing](./bullmq-async-processing.md) | Task submission reporting design review | P95 generation > 5s, HTTP timeout, or row cap removal | [BE design §4.8](../../apps/erify_api/docs/design/TASK_SUBMISSION_REPORTING_DESIGN.md) |
| [Submitted-At State Machine](./submitted-at-state-machine.md) | Task submission reporting design review | Need for precise submission timestamps beyond `status` + `updatedAt` | [BE design §4.5](../../apps/erify_api/docs/design/TASK_SUBMISSION_REPORTING_DESIGN.md) |

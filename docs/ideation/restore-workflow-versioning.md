...
The `.agents/skills/database-patterns/references/07-soft-delete-restore.md` covers the restore workflow pattern for soft-deleted records, including version behavior, dependency checks, repository, service, and controller patterns. Use this as the implementation guide when promoted.

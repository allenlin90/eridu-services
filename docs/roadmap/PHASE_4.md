...
> **Last updated**: 2026-05-22 · **Status**: 🚧 Active · **Remaining**: 23 PRs · **Next**: 12.0.2 Phase 4 actuals schema additions
...
| 12.0.2 | [Phase 4 actuals schema additions](../prd/task-fact-binding.md#section-a-foundation-prs-1201--1205) — single Prisma migration materializing design doc §2.A: nullable actuals columns + indexes on `Show` / `ShowCreator` / `ShowPlatform`; empty `ShowPlatformViolation` table; `ShowPlatform.performanceMetrics`. No consumers wired. | —                    | 🚧 In progress                | —                                                                         |
...
| 12.5   | [Show performance analytics infrastructure investigation](../ideation/show-performance-analytics-infra.md) — post-12.4 design decision on whether to extend current services with read models/materialized views or introduce OLAP infrastructure for show-level analytical features. | PR 12.4              | 🔲 Planned investigation      | —                                                                         |

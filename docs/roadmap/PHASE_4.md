...
> **Last updated**: 2026-06-02 · **Status**: 🚧 Active · **Remaining**: 13 PRs · **Next**: 12.6 Show performance analytics infrastructure investigation
...
| ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- | ---------------------------- | ------------------------------------------------------------------------- |
| 12     | [Critical task-input semantics for actuals and operations review](#pr-12--meta-row) — meta-row. Design locked in [#90](https://github.com/allenlin90/eridu-services/pull/90); shipped as 12.0.1-12.4.7 (last sub-PR [#120](https://github.com/allenlin90/eridu-services/pull/120)). Analytics infrastructure tracked separately as 12.6.                                              | PR 4                 | ✅ Shipped                    | [#90](https://github.com/allenlin90/eridu-services/pull/90) (design)      |

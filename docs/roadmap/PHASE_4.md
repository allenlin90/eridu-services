...
> **Last updated**: 2026-05-26 · **Status**: 🚧 Active · **Remaining**: 16 PRs · **Next**: 12.4.4 Operational facts summary and filters
...
| 12.4.4 | [Operational facts summary and filters](../prd/task-fact-binding.md#section-c-review-surface-pr-124) — summarize confirmed extracted facts only: show actuals completeness, late/missing creators with reasons, active platform violations, and incomplete phase checks. | PR 12.4.3            | 🔲 Planned                    | —                                                                         |

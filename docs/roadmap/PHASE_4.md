...
> **Last updated**: 2026-05-25 · **Status**: 🚧 Active · **Remaining**: 20 PRs · **Next**: 12.4.1 Operations Review foundation
...
| 12.4.1 | [Operations Review foundation](../prd/task-fact-binding.md#section-c-review-surface-pr-124) — Show Run Review shell at `/show-run-review`, Task Setup route at `/task-setup`, operational-day date range controls, and consolidation of submitted-task review under `/task-review`. | PR 12.3.2            | 🚧 In progress                | —                                                                         |
| 12.4.2 | [Task review summary and exception queues](../prd/task-fact-binding.md#section-c-review-surface-pr-124) — summarize `REVIEW` tasks by operational day/range in `/task-review`, identify ready-for-approval rows, and tag blocking issues by pre-production, on-air, and post-production phase. | PR 12.4.1            | 🔲 Planned                    | —                                                                         |

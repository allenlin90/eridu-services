...
| 12.4.5 | [Range sign-off audit](../prd/task-fact-binding.md#section-c-review-surface-pr-124) — manager/admin sign-off for an operational day/range with unresolved exception counts captured in audit history. | PR 12.4.4            | 🔲 Planned                    | —                                                                         |

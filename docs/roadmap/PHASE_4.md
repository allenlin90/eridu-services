...
| 1f  | Studio schedule management               | [PRD](../prd/studio-schedule-management.md)                        | 🔲 Planned                        | 1+     | Extends 1e with show assignment, validation, publish, and snapshots. Branch: `feat/1f-studio-schedule-management`. PRD finalized 2026-04-07. V1: chronological show ordering; studio-native publish (snapshot + status, no planDocument sync); duplicate = empty.  |

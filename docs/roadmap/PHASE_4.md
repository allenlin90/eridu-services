...
| 12.4.1 | [Operations Review foundation](../prd/task-fact-binding.md#section-c-review-surface-pr-124) — `/operations-review` shell, sidebar workflow rename (`Show Operations` → `Production Planning`), operational-day range controls, and two-layer summary framing: submission review before operational facts review. | PR 12.3.2            | 🚧 In progress                | —                                                                         |
...
1. **Studio Overview** (e.g. `/operations-review`, `/show-operations`, creator + member roster tables)

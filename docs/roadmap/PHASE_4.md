...
| 12.4.1 | [Operations Review foundation](../prd/task-fact-binding.md#section-c-review-surface-pr-124) — Show Run Review shell at `/show-run-review`, sidebar workflow rename (`Show Operations` → `Task Setup`), operational-day date range controls, and consolidation of submitted-task review under `/task-review`. | PR 12.3.2            | 🚧 In progress                | —                                                                         |
...
1. **Studio Overview** (e.g. `/task-review`, `/show-run-review`, `/show-operations`, creator + member roster tables)

...
| R   | Economics cost model review              | [PRD](../prd/economics-cost-model.md)                              | 🔲 Planned                        | Post-1 | Activated 2026-04-22 as the next critical-path step. Doc-only output: lock projected-vs-actual semantics plus bonus/OT/allowance/deduction composition rules. Gates R+ and E0.                                                                                    |
...
| Economics cost model (R)       | [PRD](../prd/economics-cost-model.md)               | N/A (docs-only; E0 / R+ / 2a implement against it)                              | N/A                                                                                 |

...
> **Last updated**: 2026-06-01 · **Status**: 🚧 Active · **Remaining**: 13 PRs · **Next**: 12.6 Show performance analytics infrastructure investigation
...
| ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- | ---------------------------- | ------------------------------------------------------------------------- |
| 12     | [Critical task-input semantics for actuals and operations review](#pr-12--meta-row) — meta-row. Design locked in [#90](https://github.com/allenlin90/eridu-services/pull/90); ships as 12.0.1-12.4.7. Flips ✅ when all sub-PRs merge.                                              | PR 4                 | 🔲 Design locked, split below | [#90](https://github.com/allenlin90/eridu-services/pull/90) (design only) |

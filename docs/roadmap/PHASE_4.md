...
| 3.5 | Shift hourly-rate editing in compensation dialog — make the compensation dialog the single surface for all per-shift money fields; remove rate input from edit-shift dialog                                                            | PR 3       | ✅ Merged  | _PR link pending_                                           |

...
| 12.0.3 | [Fact-key binding picker on task-template fields](../prd/task-fact-binding.md#section-a-foundation-prs-1201--1205) — **Producer-facing**: builder adds a `system_fact_key` dropdown per field; validator enforces field-type ↔ fact-key compatibility against real backing columns from 12.0.2. No runtime effect until 12.0.4. | PR 12.0.2            | 🚧 In progress                | —                                                                         |

...
| 12.1.1 | [Show actuals extractor](../prd/task-fact-binding.md#section-b-extractors-prs-1211--1232) — wire extractor for `show_actual_*_time` against PR 4's `Show` columns.                                                                                                         | PR 12.0.5            | ✅ Shipped                    | this PR                                                                   |

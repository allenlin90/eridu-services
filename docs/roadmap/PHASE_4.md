...
| 12.0.1 | [`Audit` / `AuditTarget` foundation](../prd/task-fact-binding.md#section-a-foundation-prs-1201--1205) — new Prisma models, migration, repo/service/Zod, legacy `metadata.audit.snapshot_overrides[]` sidecar reader. No consumers yet.                                                              | —                    | 🚧 In progress                | —                                                                         |

...
> **Last updated**: 2026-05-22 · **Status**: 🚧 Active · **Remaining**: 21 PRs · **Next**: 12.0.3 Fact-key binding picker on task-template fields
...
| 12.0.3 | [Fact-key binding picker on task-template fields](../prd/task-fact-binding.md#section-a-foundation-prs-1201--1205) — **Producer-facing**: builder adds a searchable "Save answer as" binding picker per field; validator enforces field-type ↔ fact-key compatibility and one binding per fact key in a template against real backing columns from 12.0.2. No runtime effect until 12.0.4. | PR 12.0.2            | 🚧 In progress                | —                                                                         |

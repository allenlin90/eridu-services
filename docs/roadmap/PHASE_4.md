...
| Parallel | 1f  | [Studio Schedule Management](../prd/studio-schedule-management.md) | Direct extension of 1e. Studios need a workspace to assign and arrange owned shows into schedules.                 |
...
| Studio show management         | [PRD](../prd/studio-show-management.md)             | [BE](../../apps/erify_api/docs/design/STUDIO_SHOW_MANAGEMENT_DESIGN.md)         | [FE](../../apps/erify_studios/docs/design/STUDIO_SHOW_MANAGEMENT_DESIGN.md)         |

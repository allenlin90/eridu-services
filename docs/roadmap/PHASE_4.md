...
| 12.0.5 | [Extraction pipeline foundation + wire-label alignment](../prd/task-fact-binding.md#section-a-foundation-prs-1201--1205) — extraction engine + `show_actual_start_time` smoke extractor + cross-task collision guard + show-operations `has_proper_task_assignment` flag + FE amber `No Task Assigned` badge. Source labels reconciled on the short forms already in `actualsSourceSchema`; no code-level rename was needed.                                                                                                                                                                                                                                                              | PR 12.0.1, PR 12.0.4 | ✅ Shipped                    | [#98](https://github.com/allenlin90/eridu-services/pull/98)               |
...
| 12.4.1 | [Operations Review foundation](../prd/task-fact-binding.md#section-c-review-surface-pr-124) — Submission Review and Show Run Review shells, sidebar workflow rename (`Show Operations` → `Production Planning`), operational-day range controls, and separated pre-confirmation vs post-confirmation review workspaces. | PR 12.3.2            | 🚧 In progress                | —                                                                         |
| 12.4.2 | [Submission review summary and exception queues](../prd/task-fact-binding.md#section-c-review-surface-pr-124) — summarize `REVIEW` tasks by operational day/range, identify ready-for-approval rows, and tag blocking issues by pre-production, on-air, and post-production phase. | PR 12.4.1            | 🔲 Planned                    | —                                                                         |
...
1. **Studio Overview** (e.g. `/operations-review/submissions`, `/operations-review/show-runs`, `/show-operations`, creator + member roster tables)

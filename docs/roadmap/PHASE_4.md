...
> **Last updated**: 2026-05-24 · **Status**: 🚧 Active · **Remaining**: 16 PRs · **Next**: 12.3.2 ShowPlatformViolation extractor
...
| 12.3.2 | [`ShowPlatformViolation` extractor](../prd/task-fact-binding.md#section-b-extractors-prs-1211--1232) — replace-all scoped to `(sourceTaskId, sourceFieldId)`. Table already exists from 12.0.2.                                                                                                   | PR 12.1.2            | 🚧 In progress                | —                                                                         |

...
| 4   | Show-operations export + actuals at `/show-operations` — unified date range, export, show-actuals input, missing-actuals queue; plus `ResponsiveDateTimePicker` (vaul `Drawer` below `md`) and the desktop-Dialog/mobile-Drawer house pattern doc                                                                                                                                      | —          | ✅ Ready   | [#75](https://github.com/allenlin90/eridu-services/pull/75) |

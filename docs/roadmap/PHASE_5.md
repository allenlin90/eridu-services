...
**Pickup brief (2026-08-01)**: implementing per the locked [design doc](../../apps/erify_api/docs/design/SHOW_ISSUE_OWNERSHIP_DESIGN.md) Delivery Sequence. This pass covers steps 1–2 (Prisma model/migration, repository/service, `SHOW_ISSUE` audit-target extension, manual workflow API with authorization/optimistic locking/audit coverage, tests). Steps 3–5 (show detail Issues tab, transactional attendance/platform-violation reconciliation, Show Run Review summary) follow in a subsequent pass.

...
- **Phase 5** (In progress): Show Production Lifecycle Gap Closure — lifecycle alignment, creator roster intake, cancellation resolution, import/correction records, issue ownership, and scheduling consistency; state-machine enforcement follows once readiness and completion review contracts are stable.

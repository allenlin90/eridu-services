...
> **Blocks**: Page-local exports (PR 1-2 in [PHASE_4_REMAINING.md](../roadmap/PHASE_4_REMAINING.md)); full studio autonomy (Studio Schedule Management was deferred on 2026-04-22 — see [future PRD](../prd/future/studio-schedule-management.md))
...
- Related feature: [Page-local exports (PR 1-2)](../roadmap/PHASE_4_REMAINING.md) — studio-owned shows feed into `/show-operations` export

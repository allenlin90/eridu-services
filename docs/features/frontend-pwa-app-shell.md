...
- The production static server limits its SPA fallback to extensionless client routes; asset-like misses return 404 so a CDN cannot cache HTML under a CSS or JavaScript URL.
...
- [x] Production hosting rewrites extensionless client routes while missing asset-like paths return 404

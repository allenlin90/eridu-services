...
Stale Wave 2, Wave 3, and future revenue economics design drafts were removed after 2.1 sign-off because they encoded pre-simplification assumptions. Active app-local redrafts are linked from the relevant PRDs.

...
| [table-view-pattern skill](../../.agents/skills/frontend-ui-components/references/table-view-pattern.md) | Mandates for tabular pagination, URL state, and selection checks |

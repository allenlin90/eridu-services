# Extracting DataTable to Shared UI Package

This reference documents the rationale, design decisions, and consequences of extracting the robust `data-table` component suite out of `erify_studios` and into the shared `@eridu/ui` package.
...
We evaluated three potential paths:

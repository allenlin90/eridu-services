...
description: Service worker segregation, double-caching anti-pattern, iOS pitfalls, and CDN cache-poisoning prevention for eridu-services PWAs.
status: stable
stale_after: "2027-01-01"
sources:
  - title: PWA app shell feature doc
    path: docs/features/frontend-pwa-app-shell.md
  - title: erify_studios PWA shell runbook
    path: apps/erify_studios/docs/PWA_SHELL_RUNBOOK.md
  - title: PWA runtime implementation
    path: apps/erify_studios/src/lib/pwa/pwa-runtime.ts
---

# PWA Best Practices

Architectural guidelines for building and maintaining PWAs in the React ecosystem. Selected by the [`pwa-best-practices`](../../.agents/skills/pwa-best-practices/SKILL.md) skill.

## Monorepo Rollout

- App-by-app rollout: `erify_studios` (first) and `erify_creators` (second)
- Reference: [`docs/features/frontend-pwa-app-shell.md`](../../docs/features/frontend-pwa-app-shell.md), [`apps/erify_studios/docs/PWA_SHELL_RUNBOOK.md`](../../apps/erify_studios/docs/PWA_SHELL_RUNBOOK.md), and [`apps/erify_creators/docs/PWA_SHELL_RUNBOOK.md`](../../apps/erify_creators/docs/PWA_SHELL_RUNBOOK.md)
...
- Reference: [`apps/erify_studios/src/lib/pwa/pwa-runtime.ts`](../../apps/erify_studios/src/lib/pwa/pwa-runtime.ts)

...
title: Database Patterns (Prisma / PostgreSQL)
description: Canonical persistence doctrine for eridu-services — soft delete, transactions, optimistic locking, polymorphism, audit history, and migration policy.
status: stable
stale_after: "2027-01-01"
sources:
  - title: erify_api transaction integration harness
    path: apps/erify_api/test/README.md
  - title: erify_api architecture and persistence matrix
    path: apps/erify_api/docs/ARCHITECTURE.md
---

# Database Patterns (Prisma / PostgreSQL)

The single source of truth for database interactions in Eridu Services. Selected by the [`database-patterns`](../../.agents/skills/database-patterns/SKILL.md) skill.

For detailed code examples, read the corresponding file from the skill's `references/` directory as needed.
...
> 📖 [references/02-bulk-operations.md](../../.agents/skills/database-patterns/references/02-bulk-operations.md)
...
> 📖 [references/03-transactions.md](../../.agents/skills/database-patterns/references/03-transactions.md)

## 4. Query Optimization

Prevent N+1 queries with `include`. Use `Promise.all` for independent queries.

> 📖 [references/04-query-optimization.md](../../.agents/skills/database-patterns/references/04-query-optimization.md)

## 5. Nested Connect

Use `connect: { uid }` to link entities. Avoids extra reads.

> 📖 [references/06-relationships-and-nested-writes.md](../../.agents/skills/database-patterns/references/06-relationships-and-nested-writes.md)
...
> 📖 [references/05-optimistic-locking.md](../../.agents/skills/database-patterns/references/05-optimistic-locking.md)
...
- [`repository-pattern-nestjs`](../../.agents/skills/nestjs-architecture/references/repository-pattern.md) — Repository class patterns

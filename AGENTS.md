...
- Store actual timestamps, performance facts, and revenue facts on the narrowest entity whose fact they describe. Do not persist derived finance totals on operational tables.

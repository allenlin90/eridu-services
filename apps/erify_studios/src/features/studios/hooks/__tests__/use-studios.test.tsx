...
vi.mock('@/features/studios/api/create-studio', () => ({
  useCreateStudio: vi.fn(() => ({
    mutateAsync: vi.fn(),
    isPending: false,
  })),
}));

vi.mock('@/features/studios/api/update-studio', () => ({
  useUpdateStudio: vi.fn(() => ({
    mutateAsync: vi.fn(),
    isPending: false,
  })),
}));

vi.mock('@/features/studios/api/delete-studio', () => ({
  useDeleteStudio: vi.fn(() => ({
    mutateAsync: vi.fn(),
    isPending: false,
  })),
}));
...
describe('useStudios', () => {
  ...
  it('should return studios data and mutations', () => {

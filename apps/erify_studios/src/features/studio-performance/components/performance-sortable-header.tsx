...
/**
 * Column header button for the multi-sort performance table. Shows the sort
 * direction and the 1-based priority badge when the column participates in the
 * active sort rule list; clicking cycles unsorted → asc → desc → unsorted via
 * `onSort`.
 */

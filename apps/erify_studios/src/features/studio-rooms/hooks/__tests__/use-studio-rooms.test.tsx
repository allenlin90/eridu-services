...
import { useStudioRooms } from '../use-studio-rooms';
...
describe('useStudioRooms', () => {
  ...
  it('should return studio rooms data and mutations', () => {
    const { result } = renderHook(() => useStudioRooms('studio-123'), {
  ...
  it('should provide handleRefresh and handleCreate functions', () => {
    const { result } = renderHook(() => useStudioRooms('studio-123'), {
      wrapper: createWrapper(),
    });

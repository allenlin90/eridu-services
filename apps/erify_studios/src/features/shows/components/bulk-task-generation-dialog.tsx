...
export function BulkTaskGenerationDialog({
  ...
  return (
    <ResponsiveDialog
      ...
      description="Select task templates to generate tasks across the chosen shows."
      footer={footer}
      contentClassName="sm:max-w-[560px] max-h-[90vh] overflow-y-auto overflow-x-hidden"
      mobileBodyClassName="overflow-x-hidden pb-4"
    >

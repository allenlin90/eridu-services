...
import { useShowStandards } from '../use-show-standards';
...
vi.mock('@/features/show-standards/api/create-show-standard', () => ({
  useCreateShowStandard: vi.fn(() => ({
    mutateAsync: vi.fn(),
    isPending: false,
  })),
}));

vi.mock('@/features/show-standards/api/update-show-standard', () => ({
  useUpdateShowStandard: vi.fn(() => ({
    mutateAsync: vi.fn(),
    isPending: false,
  })),
}));

vi.mock('@/features/show-standards/api/delete-show-standard', () => ({
  useDeleteShowStandard: vi.fn(() => ({
    mutateAsync: vi.fn(),
    isPending: false,
  })),
}));

describe('useShowStandards', () => {
  const createWrapper = () => {
  ...
  it('should return show standards data and mutations', () => {
    const { result } = renderHook(() => useShowStandards(), {

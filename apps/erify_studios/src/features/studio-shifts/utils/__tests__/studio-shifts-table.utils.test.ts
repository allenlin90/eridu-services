    ...
    const shifts = sortShiftsByFirstBlockStart([
      {
        ...
        status: 'SCHEDULED',
        metadata: {},
        blocks: [{ id: 'b2', start_time: '2026-03-05T14:00:00.000Z', end_time: '2026-03-05T16:00:00.000Z', actual_start_time: null, actual_end_time: null, metadata: {}, created_at: '', updated_at: '' }],
        created_at: '',
        updated_at: '',
      },
      {
        ...
        status: 'SCHEDULED',
        metadata: {},
        blocks: [{ id: 'b1', start_time: '2026-03-05T09:00:00.000Z', end_time: '2026-03-05T10:00:00.000Z', actual_start_time: null, actual_end_time: null, metadata: {}, created_at: '', updated_at: '' }],
        created_at: '',
        updated_at: '',
      },
    ]);

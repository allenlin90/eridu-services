...
- "Latest finalized task with a loop schema wins" per show (reuses the PR 22.1 selection rule, `FINALIZED_LOOP_TASK_STATUSES`); a planned show with no task reads as unassigned.

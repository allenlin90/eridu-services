...
- `apps/erify_api/docs/DESIGN_BE_SCHEDULE_DIFF_UPSERT_IMPLEMENTATION_PLAN.md`
...
3. Display publish summary metrics in relevant admin surfaces if API exposure exists.
...
2. Add optional filtered views for pending-resolution queue.

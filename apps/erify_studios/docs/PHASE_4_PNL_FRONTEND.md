...
| 2.2 | Compensation line items + actuals          | 🚧 In progress  | [compensation-line-items.md](../../../docs/prd/compensation-line-items.md)               | [COMPENSATION_LINE_ITEMS_DESIGN.md](./design/COMPENSATION_LINE_ITEMS_DESIGN.md)            |

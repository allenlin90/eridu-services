...
describe('isTimeOverlapping', () => {
  it.each([
    ...
    ['second range starts during first', '10:00', '12:00', '11:00', '13:00', true],
    ['first range starts during second', '11:00', '13:00', '10:00', '12:00', true],
    ['containing range', '10:00', '14:00', '11:00', '13:00', true],
    ['contained range', '11:00', '13:00', '10:00', '14:00', true],
    ['touching edges', '10:00', '12:00', '12:00', '14:00', false],
    [
      'touching edges in reverse order',
      '12:00',
      '14:00',
      '10:00',
      '12:00',
    ...
    [
      'separate ranges in reverse order',
      '13:00',
      '15:00',
      '10:00',
      '12:00',

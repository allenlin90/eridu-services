...
import { showCreatorDto } from '@/models/show-creator/schemas/show-creator.schema';
...
export const addShowCreatorInputSchema = z.object({
  creator_id: z.string().refine(CreatorService.isValidCreatorUid, 'Invalid creator ID'),

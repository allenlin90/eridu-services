...
-- CUSTOM SQL START: Rename legacy MC tables to creator naming
-- Preserve existing data and PK/FK relationships while moving to creator terminology.
ALTER TABLE "mcs" RENAME TO "creators";
ALTER TABLE "show_mcs" RENAME TO "show_creators";
-- CUSTOM SQL END

-- AlterTable: add compensation fields to creators
...
-- AlterTable: add compensation fields to show_creators
...
-- CreateTable: studio_creators (studio-scoped talent roster)
...
ALTER TABLE "studio_creators"
  ADD CONSTRAINT "studio_creators_studio_id_fkey" FOREIGN KEY ("studio_id") REFERENCES "studios"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "studio_creators"
  ADD CONSTRAINT "studio_creators_mc_id_fkey" FOREIGN KEY ("mc_id") REFERENCES "creators"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- CUSTOM SQL START: Backfill studio_creators from historical show_creators assignments

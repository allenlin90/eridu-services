...
| [Pending-Resolution Discovery & Observability](docs/design/IMPLEMENTATION_CANCELLED_PENDING_RESOLUTION_GAP_MVP.md) | 📐      | Backend resolve workflow shipped (see [Show Cancellation Gate](docs/SHOW_CANCELLATION_GATE.md)); remaining gap is FE discovery + observability |

...
// their schema home (typed column vs read-model vs OLAP) is decided in PR 21
  // (see docs/features/show-performance-analytics.md).
...
| Platform performance (GMV, viewer count, etc.) | deferred to PR 21 — see [`show-performance-analytics.md`](../../../../docs/features/show-performance-analytics.md) | analytical layer (TBD: read model vs OLAP) | PR 21 |

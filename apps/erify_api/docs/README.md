...
| [Analytics Dashboard](./design/ANALYTICS_DASHBOARD.md)                                    | ⚠️ Superseded | In-app `TaskAnalyticsSnapshot` approach replaced by Datastream + BigQuery (Phase 4); historical reference only |

...
3. [Pending-Resolution Discovery & Observability](./IMPLEMENTATION_CANCELLED_PENDING_RESOLUTION_GAP_MVP.md) — Backend resolve workflow shipped ([Show Cancellation Gate](../SHOW_CANCELLATION_GATE.md)); remaining gap is FE discovery queue + observability counters

...
9. [`erify_api` Architecture Refactoring Guide](./ARCHITECTURE_REFACTORING_GUIDE.md) — Accepted capability-first modular-monolith direction with a pilot-gated persistence matrix and CQRS decision gates

---
name: eridu-security-threat-model
description: Threat-model eridu-services trust boundaries and abuse paths only on explicit AppSec requests, not general review.
---

...
4. Add or update specs at behavior altitude (see [`backend-testing-patterns`](../backend-testing-patterns/SKILL.md)).
5. Verify.
...
Changes affecting transaction semantics, soft-delete/restore, CLS participation, or Nest runtime composition also require the guarded real-database gate in [`backend-testing-patterns`](../backend-testing-patterns/SKILL.md#5-real-database-integration-tests). Record the result in the PR.

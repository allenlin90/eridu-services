...
1. **Studio Overview (Perspective 1)**: Aggregate dashboards, filtered grids, and operations tables (e.g. `/operations-review`, `/show-operations`, creator/member roster tables). Manager-facing, studio-wide visibility.
...
- `OperationalFactsSummary`: Shared range summary for confirmed show actuals, creator attendance, phase checks, and active violations.

...
const SKILL_BATCHES = [
  {
    ...
    files: [
      ...
      '.agents/skills/nestjs-architecture/references/controller-pattern.md',
  ...
  },
  {
    ...
    files: [
      ...
      '.agents/skills/database-patterns/references/07-soft-delete-restore.md',
      ...
      '.agents/skills/database-patterns/references/08-local-database-cli.md',
  ...
  },
  {
    ...
    files: [
      ...
      '.agents/skills/code-quality/references/backend-testing-patterns.md',
  ...
  },
  {
    ...
    files: [
      '.agents/skills/code-quality/references/secure-coding-practices.md',

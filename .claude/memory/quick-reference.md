...
- `knowledge/engineering/table-view-pattern.md` § Current-View Export — canonical rules (`frontend-ui-components` § table view is the thin procedure that selects it)

...
| Orchestration: alignment | ✅ Past-show skip and studio-membership scoping for assigned MC checks (non-member MCs excluded from missing coverage counts)                                         | None identified in reviewed scope                      |

...
| FE components        | ✅ Initial coverage for duty manager/calendar cards and table orchestration interactions | Broader form/dialog field-level interaction coverage         |
